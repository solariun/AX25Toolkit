...
static void usage() {
    printf(
        ...
        "\n"
        "Options:\n"
        "  -c CALL           Callsign (for monitor display)\n"
        "  -s SPEED          Baud rate: 300, 1200, 9600 (default: 1200)\n"
        "  -d DEVICE         Audio device (ALSA: \"default\"; CoreAudio: ignored)\n"
        "  -r RATE           Sample rate: 44100, 48000 (default: 44100)\n"
        ...
        "\n"
        "Examples:\n"
        "  modemtnc -s 1200 --link /tmp/kiss --monitor\n"
        "  modemtnc -s 9600 -d hw:1 --server-port 8001 --monitor\n"
